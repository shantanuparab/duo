...
export const MILESTONES = [
  ...
  { level: 3,  title: "Hot Takes",            emoji: "🔥", unlock: "Hot Takes + Adventures Ch.1 (Love Maps) + gifts",  unlockedDecks: ["hottake"], feature: "gifts,songs,adventures" },
  { level: 4,  title: "Playground",           emoji: "🎾", unlock: "Pet playground",                   unlockedDecks: [], feature: "playground" },
  { level: 5,  title: "Butterflies",          emoji: "🦋", unlock: "Butterflies + bouquets + Adventures Ch.2 (Becoming Closer)",          unlockedDecks: ["spicy"], feature: "bouquets" },
  { level: 6,  title: "Getting Real",         emoji: "🎭", unlock: "2 Truths 1 Lie",                  unlockedDecks: ["2truths"] },
  { level: 7,  title: "About Us",             emoji: "💜", unlock: "About Us + love letters + Adventures Ch.3 (Becoming Us)",         unlockedDecks: ["aboutus"], feature: "loveLetter" },
  ...
  { level: 10, title: "Soulmates",            emoji: "✨", unlock: "Soulmate badge + Adventures Ch.4 (Imagined Futures)",                  unlockedDecks: [] },
  ...
  { level: 15, title: "Legendary",            emoji: "🏆", unlock: "Infinity gift + garden room + Adventures Ch.5 (The Long Game)",     unlockedDecks: [], feature: "garden" },
